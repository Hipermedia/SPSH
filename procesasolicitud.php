...
if ( isset($_POST['boton']) ) {
	...
	if ($tipopago == 'contado') {
        ...
        <tbody>
            ...
            <tr>
                <td style="background-color:#F5B641;" align="left" valign="top">
	...
	if ( isset($_POST['boton']) ) {
		...
		$subject = 'Datos de nuevo cliente interesado - '. $id_compra ;
		...
		$mail->Body = $message;
		$message;
		$mail->AddReplyTo($GLOBALS['correo_contacto_comercio'], 'GCRH Consultores');
		$mail->setFrom($GLOBALS['ses_verified_sender'], 'Sistema de pagos');		

		//Send the message and check for errors
		if (!$mail->send()) {
			echo "Mailer Error: " . $mail->ErrorInfo;
		} else {
			//echo "Message sent by SES!";
		}
