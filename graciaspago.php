...
//if ( $ok ) {
   ...
   //header('HTTP/1.1 200 OK'); 
	...
	if ( isset($_POST['txn_type']) ) {
		...
		//Configuración SMTP
		require_once "Mail.php"; // calls pear mail packages
...
?>
    ...
    <div id="psh-content">
    <h1 align="center" id="psh-titulo-pagina">Gracias por tu pago</h1>
    
            Hola <?php echo $nombre; ?>, hemos recibido tu pago te enviamos los detalles a <strong class="resaltar-correo"><?php echo $correo; ?><strong>. Revisa tu bandeja de entrada o correo no deseado y asegurate de marcarlo como correo seguro para no perder ninguna notificación en el futuro. ¡Gracias!
